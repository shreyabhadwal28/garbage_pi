# -*- coding: utf-8 -*-
"""
Created on Tue Jan 18 17:07:39 2022
...
def main():
  ...
  classes_names = ['cardboard', 'glass', 'metal','paper','plastic'] #you can change classes

  print("#load model")
  model = tensorflow.keras.models.load_model('inceptionv3_best.h5') #you can change name and path for model
